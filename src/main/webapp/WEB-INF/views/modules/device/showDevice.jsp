...
<ul class="nav nav-tabs">
    ...
    <li><a href="${ctx}/device/device/form?id=${device.id}">设备信息<shiro:hasPermission
            name="device:device:edit">${not empty device.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission
            name="device:device:edit">查看</shiro:lacksPermission></a></li>
    <li class="active">设备详情</li>
</ul>
<br/>
<table>
    <form:form id="inputForm" modelAttribute="device" action="${ctx}/device/device/save" method="post"
        ...
        <c:forEach items="device.cpus" var="cpu" >
            <tr>
                <td>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ${cpu.brand}
                            <%--<form:input path="" htmlEscape="false" maxlength="255" class="input-xlarge "/>--%>
                        </div>
                    </div>
                </td>
                <td>
        ...
        <div class="form-actions">
            <shiro:hasPermission name="device:device:edit">
