 ...
 */
package com.fxb.eams.modules.act.service.ext;
...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new com.fxb.eams.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new com.fxb.eams.modules.sys.entity.User(null, userId)))){
